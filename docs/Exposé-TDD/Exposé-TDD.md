---
layout: default
chapitre: Exposé Test-driven development (TDD)
presentation: Exposé Test-driven development (TDD)
order: 12
---
# Exposé TDD
...
TDD, ou Développement Piloté par les Tests, est une approche de développement de logiciels où l'on écrit des tests pour son code avant même d'écrire le code en lui-même. Le processus comprend généralement trois étapes principales :
