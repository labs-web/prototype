...
class ProjetImport implements ToModel, WithHeadingRow
{
    ...
    public function model(array $row)
    {
        ...
        return new Projet([
            ...
            'date_debut' => isset($row["date_debut"]) ? Carbon::createFromFormat('Y-m-d H:i:s', $row["date_debut"]) : null,
            'date_de_fin' => isset($row["date_de_fin"]) ? Carbon::createFromFormat('Y-m-d H:i:s', $row["date_de_fin"]) : null
        ]);
