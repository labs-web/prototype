...
class ActionController extends Controller
{
    ...
    public function __construct(GestionActionsRepository $actionRepository, GestionControllerRsepository $controllerRepository)
    {
    ...
    public function store(actionRequest $request)
    {
        try {
            ...
            // dd($actions);
            return back()->with('success', __('pkg_autorisations/ActionException/message.ActionAdded'));
        } catch (ActionException $e) {
            return back()->with('error',  __('pkg_autorisations/ActionException/message.createActionException'));
        }
        catch (\Exception $e) {
            return abort(500);
        }
    ...
    public function update(Request $request, $action_id)
    {
        try {
            ...
            return back()->with('success', __('pkg_autorisations/ActionException/message.ActionUpdated'));
        } catch (ActionException $e) {
            return back()->withInput()->withErrors(['Action_exists' => __('pkg_autorisations/ActionException/message.updateActionException')]);
        } catch (\Exception $e) {
            return back()->withInput()->withErrors(['unexpected_error' => __('pkg_autorisations/ActionException/message.unexpected_error')]);
        }
    }
