@extends('layouts.app')
@section('title', __('pkg_competences/niveauxCompetence.singular'))
                    ...
                    <h1>
                        @php
                            ...
                            $translatedName = TranslationHelper::getTitle(
                                __('pkg_competences/niveauxCompetence.singular'),
                                $lang,
                            );
                            echo $translatedName;
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        @include('pkg_competences.niveauxCompetences.table')
                    </div>
                </div>
            </div>
        </div>
