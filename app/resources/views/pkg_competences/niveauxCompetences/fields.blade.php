<form action="{{ $dataToEdit ? route('niveauxCompetences.update', $dataToEdit->id) : route('niveauxCompetences.store') }}" method="POST">
    @csrf
    @if ($dataToEdit)
        @method('PUT')
    @endif
    ...
    <div class="card-footer">
        <a href="{{ route('niveauxCompetences.index') }}" class="btn btn-default">{{ __('app.cancel') }}</a>
