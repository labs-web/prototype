...
<!-- Content Wrapper. Contains page content -->
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{ __('utilisateurs/messages.Users list') }}</h1>
                </div>
                <div class="col-sm-6">
                    <div class="float-sm-right">
                        <a href="{{route('utilisateurs.create')}}" class="btn btn-info btnAdd">  <i class="fas fa-plus"></i> {{ __('utilisateurs/messages.Create a Users') }}</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class=" p-0">
                        <div class="input-group input-group-sm float-sm-right col-md-3 p-0">
                            <input type="text" name="search" class="form-control float-right"
                             id="searchInput" placeholder="{{ __('utilisateurs/messages.Search') }}">
...
$(document).ready(function() {
    ...
    <div>
        {{ __('utilisateurs/messages.if you are sure you want to delete this utilisateur') }}
        <strong>"${utilisateurName}"</strong>
        {{ __('utilisateurs/messages.Click the Delete button to continue') }}
    </div>
`);        
